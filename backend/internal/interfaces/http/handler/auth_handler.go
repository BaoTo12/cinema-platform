...
func NewAuthHandler(authService *authapp.Service, validator *validator.Validator) *AuthHandler {
	return &AuthHandler{
...
// @Accept json
// @Produce json
// @Param request body authapp.RegisterRequest true "Registration details"
// @Success 201 {object} response.Response{data=authapp.AuthResponse}
...
// @Accept json
// @Produce json
// @Param request body authapp.LoginRequest true "Login credentials"
// @Success 200 {object} response.Response{data=authapp.AuthResponse}
// @Failure 400 {object} response.Response
...
// @Accept json
// @Produce json
// @Param request body authapp.RefreshTokenRequest true "Refresh token"
// @Success 200 {object} response.Response{data=authapp.TokenRefreshResponse}
// @Failure 400 {object} response.Response
// @Failure 401 {object} response.Response
...
// @Produce json
// @Security BearerAuth
// @Param request body authapp.RefreshTokenRequest true "Refresh token to revoke"
...
// @Accept json
// @Produce json
// @Param request body authapp.ForgotPasswordRequest true "Email address"
// @Success 200 {object} response.Response
// @Failure 400 {object} response.Response
// @Router /auth/forgot-password [post]
func (h *AuthHandler) ForgotPassword(c *gin.Context) {
	var req authapp.ForgotPasswordRequest
	if err := c.ShouldBindJSON(&req); err != nil {
		response.BadRequest(c, "Invalid request body")
		return
	}
...
// @Accept json
// @Produce json
// @Param request body authapp.ResetPasswordRequest true "Reset token and new password"
// @Success 200 {object} response.Response
// @Failure 400 {object} response.Response
// @Failure 401 {object} response.Response
...
// @Produce json
// @Security BearerAuth
// @Param request body authapp.ChangePasswordRequest true "Current and new password"
// @Success 200 {object} response.Response
// @Failure 400 {object} response.Response
// @Failure 401 {object} response.Response
...
// @Produce json
// @Security BearerAuth
// @Success 200 {object} response.Response{data=authapp.UserResponse}
// @Failure 401 {object} response.Response
// @Router /auth/me [get]
...
// @Produce json
// @Security BearerAuth
// @Param request body authapp.UpdateProfileRequest true "Profile updates"
// @Success 200 {object} response.Response{data=authapp.UserResponse}
// @Failure 400 {object} response.Response
// @Failure 401 {object} response.Response
...
func (h *AuthHandler) UpdateProfile(c *gin.Context) {
	...
	var req authapp.UpdateProfileRequest
	if err := c.ShouldBindJSON(&req); err != nil {
		response.BadRequest(c, "Invalid request body")
		return
	}
